...
class RecipePlaylistModel {
  ...
  final RecipePlaylistDataModel? data;

  factory RecipePlaylistModel.fromJson(Map<String, dynamic> json){
    return RecipePlaylistModel(
      status: json["status"] ?? 0,
      message: json["message"] ?? "",
      data: json["data"] == null ? null : RecipePlaylistDataModel.fromJson(json["data"]),
    );
  }
...
class RecipePlaylistDataModel {
  RecipePlaylistDataModel({
  ...
  factory RecipePlaylistDataModel.fromJson(Map<String, dynamic> json){
    return RecipePlaylistDataModel(
