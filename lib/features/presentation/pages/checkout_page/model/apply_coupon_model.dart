class ApplyCouponModel {
  ...
  factory ApplyCouponModel.fromJson(Map<String, dynamic> json){
    return ApplyCouponModel(
      ...
      data: json["data"] == null ? null : ApplyCouponDataModel.fromJson(json["data"]),
    );
  }
...
class ApplyCouponDataModel {
  ...
  @override
  String toString(){
    return "$id, $orderId, $ebookId, $userId, $amount, $transactionId, $actualAmount, $couponId, $cuponCode, $discountPercentage, $discountAmount, $status, $response, $createdAt, $updatedAt, ";
  }
}
